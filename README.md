...
![Status](https://img.shields.io/badge/status-research%20packet-blue)
![Papers](https://img.shields.io/badge/research%20papers-10-6f42c1)
...
This repository owns reusable intelligence contracts consumed by other repos:

- Coding Harness
- Multi-AI Modal Products
- CPL Script Family
- NOVA Polyglot Engine Ring
- External AI Connector Platform
- Organism Bots MCP
- Browser Workbench Strategy
...
Validate the research packet:

```bash
python tools/validate_research_packet.py
```

Inspect the core manifest and research index:

```bash
cat nova-intelligence.manifest.json
cat research/RESEARCH_INDEX.md
cat research/RESEARCH_CERTIFICATION_MATRIX.md
```
...
| Surface | File |
| --- | --- |
| Research index | `research/RESEARCH_INDEX.md` |
| Certification matrix | `research/RESEARCH_CERTIFICATION_MATRIX.md` |
...
The first packet includes 10 papers covering:

1. House Codex runtime governance
2. Foundation-model runtime profiles
3. Coding harness and multi-AI modal products
4. External AI connector platform
5. CPL language family
6. Language engine ring
7. NOVA recursive miniverse
8. NOVA protocol suite
9. NOVA surface strategy
...
- `nexus` registers this repo in MDFUC.
- `PhantomSDK` packages these contracts for builders and local AIs.
- `x-mcp-skills` turns connector contracts into skills.
- `organism-bots-mcp-server` consumes bot and route contracts.

## Truth Line

Research becomes trunk doctrine only after executable claims are verified against code, tests, release artifacts, or tracked implementation tickets. The repo is allowed to be ambitious, but it must stay honest about proof.

## GitHub Discoverability

Recommended repository topics:

`nova`, `ai-research`, `ai-agents`, `runtime-contracts`, `mcp`, `model-context-protocol`, `wasm`, `developer-tools`, `ai-governance`, `agent-platform`, `polyglot-runtime`.
